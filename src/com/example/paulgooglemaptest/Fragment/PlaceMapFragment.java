...
public class PlaceMapFragment extends SherlockMapFragment {
...
//				Toast.LENGTH_SHORT).show();
		...
		if (item.getItemId() == R.id.show_my_location) {
	        ...
	        xy_center = proj.toScreenLocation(followMeLocationSource.myPreviousLoc);
	        Toast.makeText(getActivity(),"my location:" + followMeLocationSource.myPreviousLoc.toString() + "xy:" + 
	        xy_center.toString(), Toast.LENGTH_SHORT).show();
	        		
			//Log.i(TAG, "my location:" + myPreviousLoc.toString() + "xy:" + xy_center.toString());
	 ...
	 */
	public class FollowMeLocationSource implements LocationSource,
			LocationListener {
